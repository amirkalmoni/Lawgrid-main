...
const HeadSEO = ({ site = {}, page = {}, schema }) => {
  ...
  // console.log(page.seo?.shareTitle)
  ...
  return (
    <Head>
      <meta charSet="utf-8" />
      {/* <meta name="google-site-verification" content="lHOono40MjI581OLKURuEXMPIAjq-zz9sYZ-xeeZeto" /> */}
...
function replaceTemplateTags(string, templateTags = []) {
  // console.log('meeee', string, templateTags)
  let newString = string

  templateTags.map((v) => {
    newString = newString
      ? newString.replace(new RegExp(v.tag, 'g'), v.value)
      : ''
  })
